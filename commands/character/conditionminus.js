...
module.exports = class ConditionMinusCommand extends Command {
    constructor(client) {
        super(client, {
            name: 'condition-',
            group: 'character',
            memberName: 'condition-',
            description: 'remove a condition tick from your character',
            examples: ['`!condition- type number`'],
            args: [
                {
                    key: 'type',
                    prompt: 'What condition are you unmarking?',
                    type: 'string'
                },
                {
                    key: 'boxes',
                    prompt: 'How many boxes are you unmarking?',
                    type: 'integer'
                }
            ]
        });
